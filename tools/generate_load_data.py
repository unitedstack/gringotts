...
mysql> LOAD DATA INFILE '/tmp/load_bill.sql' INTO TABLE gringotts.bill; LOAD DATA INFILE '/tmp/load_order.sql' INTO TABLE gringotts.`order`; LOAD DATA INFILE '/tmp/load_subs.sql' INTO TABLE gringotts.subscription;
"""
    ...
    with open('/tmp/load_bill.sql', 'w') as f2:
        with open('/tmp/load_subs.sql', 'w') as f3:
            for i in xrange(30000):
                ...
                project_id='0b8625de6d5a403d8f96d3445d3bd27e'
