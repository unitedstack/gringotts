...
class TestOrders(FunctionalTest):
    ...
    def test_get_orders(self):
        ...
        self.assertEqual('0.0170', data['orders'][1]['total_price'])
        self.assertEqual('0.1053', data['orders'][2]['total_price'])
        self.assertEqual('0.0303', data['orders'][3]['total_price'])

        # volume
        self.assertEqual('0.0040', data['orders'][4]['total_price'])
        self.assertEqual('0.0047', data['orders'][5]['total_price'])

        # router
        self.assertEqual('0.0500', data['orders'][6]['total_price'])
    ...
    def test_get_single_order(self):
        ...
        # check vm3
        order_id = orders['orders'][2]['order_id']
